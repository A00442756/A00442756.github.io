...
class Town extends Component {
    ...
    weather = () => {
        axios.get('https://api.openweathermap.org/data/2.5/weather?q=Halifax&appid=146e31ab4838b9bf457e3f628372fe6e')
            .then((res) => {
                console.log(res)
    ...
    weatherIcon = () => {
        ...
        return (<div className="weatherIconContainer">
            <img className="weatherIcon" src={weatherImage} alt="Weather icon" />
        </div>)
    }
